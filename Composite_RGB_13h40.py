...
bt_105 = xr.open_dataarray("bt_105_zoom_toulouse_13h40_radius_50.nc").values
bt_123 = xr.open_dataarray("bt_123_zoom_toulouse_13h40_radius_50.nc").values
bt_87 = xr.open_dataarray("bt_87_zoom_toulouse_13h40_radius_50.nc").values
...
# Graphique
plt.title("Composite_RGB_13h40_radius_50")
plt.axis('off')
plt.savefig('Composite_RGB_13h40_radius_50.png') 
plt.show()
